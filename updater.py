...
try:
    ...
    #get USD HUF
    ratesapi_url = "https://api.ratesapi.io/api/latest?symbols=HUF&base=USD"
    ra_response = requests.get(ratesapi_url)
    ra_data = ra_response.json()
    current_usd_huf = ra_data["rates"]["HUF"]
    ...
    #y = json.loads(r.text)
    access_token = config.hive_login['token']
    bearer = "Bearer "
    ...
    sheet_instance.update_acell('B5', current_eth_rate)
    sheet_instance.update_acell('B6', current_eth_blocktime)
    sheet_instance.update_acell('B7', current_eth_blockreward)
    sheet_instance.update_acell('E4', rig_name)
    sheet_instance.update_acell('E5', hashrates[0]['hashrate']*1000)
    sheet_instance.update_acell('E6', power_draw)
    #sheet_instance.update_acell('E7', 'k' + power_cost + '*B10')
    sheet_instance.update_acell('E7', power_cost)
    sheet_instance.update_acell('E8', '=E7/B15')
    sheet_instance.update_acell('B14', current_eth_usd)
    sheet_instance.update_acell('B15', current_usd_huf)
    ...
    eth_network_block1d = sheet_instance.acell('B8').value
    rig_prob = sheet_instance.acell('E9').value
    rig_blocks_30d = sheet_instance.acell('E10').value
